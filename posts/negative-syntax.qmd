...
date: 2025-09-29
description: '**Accepted at ICLR 2026.** Evidence that a sparse set of entangled “Wasserstein neurons” in LLMs uses negative pre-activations—especially in early layers—to separate near-similar inputs; sign-specific ablations disrupt grammatical behavior while controls do not.'
